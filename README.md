...
- 6つの質問＋１（ジャンル／舞台設定／主人公／テーマ／トーン／文字数／追加情報）を順番に選択
- 選択内容に基づきローカルLLM（Ollama）がリアルタイムストリーミングで小説を生成
- 生成した小説をクリップボードにコピー、またはテキストファイルとして保存

※Version0.2.0 で、[ウラジミール・Я. プロップによる昔話の形態要素](https://note.com/rasen/n/n13950559fa13) をプロットとして自動で記入する機能をテスト追加しました。また、その他の追加設定等も自由記入できるようにしてあります。主人公の名前や恋人の名前等を記入して夢小説を作ることも可能となりました。
